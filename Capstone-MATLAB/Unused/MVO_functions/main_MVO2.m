function [ MVO_x MVO_var adjvector  nominal_return temp_Q] = main_MVO2( historical_inflation, historical_asset_returns,...
    ...
    **IN DECIMAL FORM**
    ...
    adjvector = [MVO_x' adjusted_return diag(temp_Q)];
